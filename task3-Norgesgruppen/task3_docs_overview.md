...
## Restrictions to submitting
- Daily quota: 6
- In-flight: 2

So don't submit unless you know it will work so as not to spill your chances.
...
``` 
claude mcp add --transport http nmiai https://mcp-docs.ainm.no/mcp# Welcome to Markdown+
```